...
class NotificationServiceAPI {
  static getAccessToken() async {
    final serviceAccountJson = {
      ...
      "client_email":
          "firebase-adminsdk-w8wqz@messages-d0119.iam.gserviceaccount.com",
      ...
      "client_x509_cert_url":
          "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-w8wqz%40messages-d0119.iam.gserviceaccount.com",
  ...
  static sendMessage(String title, String message, String token) async {
    String accessToken = await getAccessToken();
    const url =
        "https://fcm.googleapis.com/v1/projects/messages-d0119/messages:send";
